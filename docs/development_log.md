...
- 2026-03-27: ViralLab 广告识别器模块已完成主链接入，包括可编辑 prompt、阈值控制、commercialIntentScore、广告库分流，以及采集后广告排除逻辑。
- 2026-03-27: ViralLab 生成链新增小红书配图建议与 AI 图片生成入口；在 `OPENAI_API_KEY` 缺失时已返回明确可读错误。
